...
#
# This is an example of a script which can be used to drop OIG schemas
...
$ORACLE_HOME/oracle_common/bin/rcu -silent -dropRepository -databaseType ORACLE  -connectString $DB_HOST:$DB_PORT/$DB_SERVICE \ -dbUser sys -dbRole sysdba -selectDependentsForComponents true \ -schemaPrefix $RCU_PREFIX \ $OIG_SCHEMAS \ -f < /tmp/pwd.txt
