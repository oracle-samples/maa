...
#
# This is an example of a script which can be used to stop the OIG Domain.
...
shutdown('oim_cluster','Cluster', ignoreSessions='true', force='true')
shutdown('soa_cluster','Cluster', ignoreSessions='true', force='true')
