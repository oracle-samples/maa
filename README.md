...
| [FMW Manual Hybrid Disaster Recovery ](./hybrid_dr) | *(Legacy)* Scripts used in the manual setup and maintenaince of a Hybrid Disaster Protection system (on-prem primary and standby on Oracle's Cloud OCI).|
